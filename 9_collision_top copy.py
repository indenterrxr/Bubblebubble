...
background  = pygame.image.load(os.path.join(current_path, "background.bmp"))
 
#버블 이미지 불러오기
bubble_images = [
    pygame.image.load(os.path.join(current_path, "red.bmp")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "yellow.bmp")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "green.bmp")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "blue.bmp")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "purple.bmp")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "black.bmp")).convert_alpha()
]


# 발사대  이미지 불러오기
pointer_image = pygame.image.load(os.path.join(current_path, "pointer.bmp"))
