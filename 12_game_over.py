...
def draw_bubbles():
    ...
    if curr_fire_count == 2:
        to_x = random.randint(0, 2) - 1 # -1에서 1 사이의 값이 나옴
    elif curr_fire_count == 1:
        to_x = random.randint(0, 8) - 4 # -4에서 4 사이의 값이 나옴
...
is_game_over = False
game_font = pygame.font.SysFont("ariralrounded", 40)
game_result = None
